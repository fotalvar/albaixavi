...
function startCountdown() {
  ...
  function updateCountdown() {
    ...
    countdownEl.innerHTML = `
      <div class="countdown-unit"><span class="countdown-number">${pad(days)}</span><span class="countdown-label">${labels.days}</span></div>
      <div class="countdown-separator">|</div>
      <div class="countdown-unit"><span class="countdown-number">${pad(hours)}</span><span class="countdown-label">${labels.hours}</span></div>
      <div class="countdown-separator">|</div>
      <div class="countdown-unit"><span class="countdown-number">${pad(minutes)}</span><span class="countdown-label">${labels.minutes}</span></div>
      <div class="countdown-separator">|</div>
      <div class="countdown-unit"><span class="countdown-number">${pad(seconds)}</span><span class="countdown-label">${labels.seconds}</span></div>
    `;
  }
